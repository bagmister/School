def main():
    ...
    if vin in vehicles_dict:
        ...
        Vehicle_info_returned = vehicles_dict[vin]
        vehicle_manufacture = Vehicle_info_returned[MANUFACTURER_INDEX]
        vehicle_model = Vehicle_info_returned[MODEL_INDEX]
        vehicle_color = Vehicle_info_returned[COLOR_INDEX]
        print(vehicle_manufacture, vehicle_model, vehicle_color)
