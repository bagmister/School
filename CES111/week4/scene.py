...
def draw_ground(canvas, scene_width, scene_height):
    ...
    lake_right =700
    bottom = 100
    draw_lake(canvas, lake_left, lake_top, lake_right, bottom)
...
def draw_pine_tree(canvas, center_x, bottom, height):
    ...
    draw_rectangle(canvas, trunk_left, trunk_top, trunk_right, bottom, outline="", width=1, fill="tan3")
...
def draw_lake(canvas, lake_left, lake_top, lake_right, bottom):
    draw_rectangle(canvas, lake_left, lake_top, lake_right, bottom, outline="gray20", width=1, fill="royalBlue")
    print()
